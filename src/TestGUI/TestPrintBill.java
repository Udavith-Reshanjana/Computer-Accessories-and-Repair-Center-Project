 ...
 * @author lenovo
 */
public class TestPrintBill extends javax.swing.JFrame {

    private Receptionalist receptionalist;
    /**
     * Creates new form TestPrintBill
     */
    public TestPrintBill() {
        initComponents();
        billHeader();
        disableTextBoxes();
    }
    ...
    private void CalculateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculateActionPerformed
        ...
        if (discountTxt.equals("")) {
            JOptionPane.showMessageDialog(null, "Please enter a positive numbers between 0 and 100.");
        } 
        else {
            try {
                ...
                JOptionPane.showMessageDialog(null, "Invalid input. Please enter valid natural numbers between 0 and 100 to discount .", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestPrintBill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TestPrintBill().setVisible(true);
            }
        });
    }
