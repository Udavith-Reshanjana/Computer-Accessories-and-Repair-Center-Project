 ...
 * @author lenovo
 */
public class TestMainCustomerUI extends javax.swing.JFrame {

    private Customer customer;
    private WholeSaleCustomer wholeSaleCustomer;
    /**
     * Creates new form TestMainCustomerUI
     */
    public TestMainCustomerUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 300, -1, -1));
        jPanel1.add(phoNoEmpIDTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 330, 120, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 0, 0));
        jLabel9.setText("Phone Number");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 300, -1, -1));
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 300, -1, -1));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(532, 410, 820, 140));
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/MainCustomerUI.png"))); // NOI18N
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        if (getCusID.isEmpty()) {
            ...
            if (!getCusNICNumber.isEmpty() && !customer.isNICValid(getCusNICNumber)) {
                ...
                customer.updateCustomer(getCusID, getCusNameTxt, getCusTypeTxt, getCusID, getCusAddress, getCusUsername, getCusPassword);
                cusIDTxt.setText("");
                cusNameTxt.setText("");
                cusTypeTxt.setSelectedIndex(0); 
                NICTxt.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestMainCustomerUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TestMainCustomerUI().setVisible(true);
            }
        });
    }
