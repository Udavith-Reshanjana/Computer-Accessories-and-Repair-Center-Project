...
//        receptionalist.setNextPaymentIDFromDatabase(paymentIDTxt);
        ...
        paymentIDTxt.setToolTipText("This field is for display only.");
        ...
        paymentIDTxt.setDisabledTextColor(Color.BLACK);
        typeTxt.setRenderer(new CustomComboBoxRenderer());
    }
//    private void billHeader() {
//    billTxt.setText("====================================================" + "\n"
//        + "                        Computer Accessories and Repair Center\n\n" 
//        + "Contact No: 0112345678\n" 
//        + "Address: No 123, Mock Street, Mock Area\n\n"
//        + "Payment ID: " + paymentIDTxt.getText() + "                                       Order ID: " + orderIDTxt.getText() + "\n" 
//        + "====================================================" + "\n" 
//        + "Item - qty			              Unit Price\n");
//}
    ...
    private void initComponents() {
        ...
        repairIDTxt1 = new javax.swing.JTextField();
        ...
        jPanel1.add(paymentIDTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 320, 210, 30));
        jPanel1.add(customerIDTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 360, 210, -1));
        jPanel1.add(orderIDTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 390, 210, -1));
        jPanel1.add(repairIDTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 420, 210, -1));
        ...
        jPanel1.add(qtyTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 480, 210, -1));
        ...
        jPanel1.add(unitPriceTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 510, 210, -1));
        ...
        jPanel1.add(usageTimeTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 570, 210, -1));

        typeTxt.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Brand New", "Second Hand" }));
        jPanel1.add(typeTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 540, 210, -1));
        ...
        jPanel1.add(hardwareIDTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 450, 210, -1));
        ...
        jLabel3.setText("Initial date of warranty ");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 610, 150, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel4.setText("Due date of warranty     ");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 660, -1, -1));

        warrantyDateTxt.setDateFormatString("yyyy-MM-dd");
        jPanel1.add(warrantyDateTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 630, 210, -1));

        warrantyDueDateTxt.setDateFormatString("yyyy-MM-dd");
        jPanel1.add(warrantyDueDateTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 680, 210, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel5.setText("Employee ID");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 720, -1, -1));
        jPanel1.add(empIDTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 720, 220, -1));
        jPanel1.add(repairIDTxt1, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 420, 210, -1));

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/paymentUI.png"))); // NOI18N
...
//        String hardwareID = hardwareIDTxt.getText();
        ...
        TestPrintBill testPrintBill = new TestPrintBill();
        testPrintBill.setVisible(true);
    ...
    private boolean isQtyValid(String hardwareID, int qtyToRemove) {
        receptionalist = new Receptionalist();
        int availableQty = receptionalist.getAvailableQuantity(hardwareID);

        return qtyToRemove <= availableQty;
    }
    ...
    private javax.swing.JTextField repairIDTxt1;
