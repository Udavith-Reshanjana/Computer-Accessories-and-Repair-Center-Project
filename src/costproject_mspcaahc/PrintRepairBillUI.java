 ...
 * @author lenovo
 */
public class PrintRepairBillUI extends javax.swing.JFrame {
...
//        totalPriceTxt.setText(Double.toString(receptionalist.calculateTotalPrice(ordID, cusID)));
    ...
    private void CalculateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculateActionPerformed
        ...
        else if (receptionalist.isNumberbetPositive(totalPriceTxt.getText())) {
            JOptionPane.showMessageDialog(null, "Please enter a positive total price value.");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrintRepairBillUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrintRepairBillUI().setVisible(true);
            }
        });
    }
